	    				...
	    				<table class="table">
                         ...
                         while($row=mysqli_fetch_assoc($sql))
                           { 
                               ...
                               <tr class="text-center">
						        <td class="product-remove"><a href="wishlist_remove.php?id=<?php echo $row["id"];  ?>"><span class="ion-ios-close"></span></a></td>
						        
						        <td class="image-prod"><a href="product-single.php?id=<?php echo $row["id"];  ?>" class="img" style="background-image:url(<?php echo $row["image"];  ?>);"></a></td>
						        ...
						        <td class="quantity" style="color:black;">
								<?php echo $q;  }?>
					          </td>
