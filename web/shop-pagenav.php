          ...
          <div class="col text-center">
            <div class="block-27">
             ...
             for($i=1; $i<=5; $i++) { 
                   $z=($i-1)*8;
                  ?>
              <?php if($i==$p){  ?>	  <li class="active"><a href="shop-pagenav.php?pg=<?php  echo $p;?>"><?php  echo $p;?></a></li><?php } ?>
            
              <?php if($z<$c && $i!=$p){  ?>	  <li><a href="shop-pagenav.php?pg=<?php  echo $i;?>"><?php  echo $i;?></a></li><?php } ?>
