...
?>
			<div class="container">
                ...
                <a href="#">   <tbody>
                    <?php
                         $u= $_SESSION['u'];     
                                 $a="SELECT * FROM my_order where email = '$u'";
              ...
              $sql=mysqli_query($conn,$a);
                ...
                {
      ?>
						      <tr class="text-center" onClick="location.href='order-details.php?id=<?php echo $row["id"];  ?>&type=<?php echo $type;  ?>'">
                     	...
                     	<p>Quantity: <?php echo $row["quan"]; ?> <?php echo $row["unit"]; ?></p>
                    <p>Farmer: <?php echo $row["f_name"]; ?></p>
						        </td>
                                 <td class="price"> <h5><?php echo $row["order_date"]; ?></h5> </td> 
                 <td class="price"><h5>₹<?php echo $row["order_price"]; ?>.00 </h5> </td> 
