...
$sdata=$_POST['searchcrop'];          
	    ...
	    <div class="container">
            ...
            <div class="sidebar-box" style="padding-right: 50px">
             <form action="shopsearch.php" class="search-form" name="search" method="post">
                <div class="form-group">
                  ...
                  <input type="search" name="searchcrop" placeholder="Search here..." value="<?php echo $sdata;  ?>"class="form-control" style="border-color: gray" >
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        ...
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item  cta cta-colored"><a href="customer.php" class="nav-link">Home</a></li>
    ...
    <section class="ftco-section" style="padding-top: 0px">
     ...
     $a="SELECT * FROM crop_fc where lower(c_name) like lower('%$sdata%') or lower(category) like lower('%$sdata%')";
      $sql=mysqli_query($conn,$a);
