...
<html lang="en">
  <head>
    <title>Admin: Complaint Category</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">Complaint Categories</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-7 ftco-animate">
          <form action="/action_page.php" class="billing-form">
            ...
            <?php
                include('connection.php');
                $a="SELECT(SELECT COUNT(user_type) FROM `complaint` WHERE user_type='Farmer') AS farmer, (SELECT COUNT(user_type) FROM `complaint` WHERE user_type='Supplier') AS supplier, (SELECT COUNT(user_type) FROM `complaint` WHERE user_type='Customer') AS customer FROM `complaint` ORDER BY user_type LIMIT 1";
                  ...
                  <div class="form-group" >
                    <div class="col-lg-20 sidebar ftco-animate">
                      ...
                      <div class="sidebar-box ftco-animate"style="padding-left: 20px;">
                        ...
                        <ul class="categories ">
                          <li><a class="a1" href="Admin_complaint_TABLE.php?type=Farmer">Farmers <span style="color: black">(<?php echo $row["farmer"]; ?>)</span></a></li>
                          <li><a class="a1" href="Admin_complaint_TABLE.php?type=Supplier">Suppliers <span style="color: black">(<?php echo $row["supplier"]; ?>)</span></a></li>
                          <li><a class="a1" href="Admin_complaint_TABLE.php?type=Customer">Customers <span style="color: black">(<?php echo $row["customer"];} ?>)</span></a></li>
                        </ul>
                      </div>
                     </div>
                </div>
