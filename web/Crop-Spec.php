...
<html lang="en">
  <head>
    <title>Crop Specialization | Farmer</title>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="sidebar-box" style="width= 100px">
      ...
      ?>	
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				...
    				<div class="product">
    					...
    					<a href="crop-spec-single.php?id=<?php echo $row['c_id']; ?>" class="img-prod"><img class="img-fluid" src="<?php echo $row["image"]; ?>" alt="Colorlib Template">
    						
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="crop-spec-single.php?id=<?php echo $row['c_id']; ?>"><b><?php echo $row["c_name"]; ?></b> </a></h3>
    					<p><?php echo $row["head1"]; ?></p>
                        <p><?php echo $row["head2"]; ?></p>
                         <br>
    						<p><a href="crop-spec-single.php?id=<?php echo $row['c_id']; ?>" class="btn btn-primary">See more</a></p>
    					</div>
                     </div>
                 	</div>
    			    <?php
