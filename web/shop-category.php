  ...
  <?php
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="sidebar-box" style="padding-right: 200px">
              <form action="#" class="search-form">
                <div class="form-group">
                  <a href="#"><span class="icon ion-ios-search"></span></a>
                ...
                <li class="second admin-pic">
				       <ul class="top_dp_agile ">
                                        ...
                                        <div class="nav-link dropdown-menu" >
              	                             <a class="dropdown-item" href="settings.php"><i class="fa fa-user"></i> Account</a> 
              	                              
                                            <a class="dropdown-item" href="wishlist.html"><i class="fa fa-heart"></i> Wishlist</a>
                                             <a class="dropdown-item" href="complaint.html"><i class="fa fa-book"></i> Complaint</a> 
    ...
    <section class="ftco-section" style="padding-top: 0px">
    	<div class="container">
    		...
    		<?php if($c=='Vegetable'){  ?>	<li><a href="shop-category.php?cat=Vegetable" class="active">Vegetables</a></li><?php } ?>
                        
            <?php if($c!='Vegetable') { ?>	<li><a href="shop-category.php?cat=Vegetable" >Vegetables</a></li><?php } ?>
                        
    		<?php if($c=='Fruit') { ?>	<li><a href="shop-category.php?cat=Fruit" class="active">Fruits</a></li><?php  } ?>
                        
    		<?php if($c!='Fruit') { ?>	<li><a href="shop-category.php?cat=Fruit">Fruits</a></li><?php } ?>	
                        
                        
    		<?php if($c=='Dried') { ?>	<li><a href="shop-category.php?cat=Dried"class="active">Dried</a></li><?php } ?>
                        
                        
            <?php if($c!='Dried') { ?>	<li><a href="shop-category.php?cat=Dried">Dried</a></li><?php } ?>
                        
                        
            <?php if($c=='Spice') { ?>   <li><a href="shop-category.php?cat=Spice"class="active">Spices</a></li><?php } ?>
                        
                        
                        
            <?php if($c!='Spice') { ?>  <li><a href="shop-category.php?cat=Spice">Spices</a></li><?php } ?>
     ...
     $a="SELECT * FROM crop_fc where category='$c'";
              $sql=mysqli_query($conn,$a);
