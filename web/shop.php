...
<html lang="en">
  <head>
    <title>Farm Assistant | Shop</title>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="sidebar-box" style="padding-right: 50px">
             <form action="shopsearch.php" class="search-form" name="search" method="post">
                <div class="form-group">
                  
                  <input type="search" name="searchcrop" placeholder="Search here..."class="form-control" style="border-color: gray" >
               <button type="submit" class="icon ion-ios-search" ></button>
                  </div>
              </form>
            </div> 
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        ...
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item  cta cta-colored"><a href="shop.php" class="nav-link">Shop</a></li>
                ...
                <li class="second admin-pic">
				       <ul class="top_dp_agile ">
                                        ...
                                        <div class="nav-link dropdown-menu" >
              	                             <a class="dropdown-item" href="my-account.php"><i class="fa fa-user"></i> My Account</a> 
              	                              
                                            <a class="dropdown-item" href="wishlist_check.php"><i class="fa fa-heart"></i> Wishlist</a>
                                            <a class="dropdown-item"  href="my-orders.php"><i class="fa fa-book"></i> My orders</a>
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li><a href="shop-category.php?cat=Vegetable">Vegetables</a></li>
    					<li><a href="shop-category.php?cat=Fruit">Fruits</a></li>
    					
    					<li><a href="shop-category.php?cat=Dried">Dried</a></li>
                        <li><a href="shop-category.php?cat=Spice">Spices</a></li>
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
	    					...
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							<a href="product-single.php?id=<?php echo $row['crop_id']; ?>" title="About product"class="add-to-cart d-flex justify-content-center align-items-center text-center">
          ...
          <div class="col text-center">
            <div class="block-27">
              <ul>
                ...
                <li><a href="shop-pagenav.php?pg=2">2</a></li>
                <li><a href="shop-pagenav.php?pg=3">3</a></li>
                <li><a href="shop-pagenav.php?pg=4">4</a></li>
                <li><a href="shop-pagenav.php?pg=5">5</a></li>
                <li><a href="#">&gt;</a></li>
              </ul>
            </div>
          </div>
