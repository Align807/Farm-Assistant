...
<html lang="en">
  <head>
    <title>View crop| Supplier</title>
    <meta charset="utf-8">
	      ...
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
	         <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item "><a href="supplier.php" class="nav-link">Home</a></li>
	         
			  <li class="nav-item"><a href="req_crop.html" class="nav-link">Request Crops</a></li>
              <li class="nav-item cta cta-colored"><a href="view_crop_check.php" class="nav-link">View Crops</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">VIEW CROPS</h1>
          </div>
        </div>
      </div>
    </div>
                ...
                <?php
                             ...
                             {$c=$row["farmer_email"];
						      ...
						      <tr class="text-center">
                                  ...
                                  <td class="image-prod"><a href="#"><div class="img" style="background-image:url(<?php echo $row["image"]; ?>);"></div></a></td>
						        
						        <td class="product-name">
						        	<h3><?php echo $row["c_name"]; ?></h3>
						        	<p><?php echo $row["quantity"]; ?> kg</p>
                                    <p>Farmer:<?php echo $row1["name"]; ?></p>
						        </td>
						        
						        <td class="price">₹<?php echo $row["price"]; ?>  </td>
						        
						        <td class="quantity">
						        	<?php $_SESSION['id']= $row["crop_id"]; ?>
                                    <a href="checkout-supplier.php?id=<?php echo $row["crop_id"]; ?>" name="accept" style="color: blue; font-size: 14px"><u><h5>Accept</h5></u>  </a>/
                                    <a href="view_crop_reject.php?id=<?php echo $row["crop_id"]; ?>"style="color: blue; font-size: 14px"><u><h5>Reject</h5></u></a>
					          </td>
...
<!-- 
                                <tr class="text-center">
                                  ...
                                  <td class="image-prod"><a href="#"><div class="img" style="background-image:url(images/product-2.jpg);"></div></a></td>
						        ...
						        <td class="quantity">
						       <a href="checkout.html" name="accept" style="color: blue; font-size: 14px"><u><h5>Accept</h5></u>  </a>/
                                    <a href="#" name="reject" style="color: blue; font-size: 14px"><u><h5>Reject</h5></u></a>
					          </td>
