...
.table .thead-primary {
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread"><?php echo $type; ?> Complaint List</h1>
          </div>
        </div>
      </div>
    </div>
 ...
 <br>
        ...
        <div class="container">
                ...
                $sql= "SELECT * FROM complaint WHERE user_type= '$type' ORDER BY FIELD (Status,'Unread','Read','Pending','Solved')";
                ...
                while($row=mysqli_fetch_array($a))
                {
                  ...
                  else 
                  {
                    ...
                    $c=$row["user_email"];
                    $sql1="SELECT name,image FROM register where  email='$c'";
                    $b=mysqli_query($conn,$sql1);
                    $row1=mysqli_fetch_assoc($b);
                ?>
						      <tr class="text-center">
                    <td class="product-remove"><a href="#"><span class="ion-ios-close"></span></a></td>
                    <td class="view-complaint"><a href="Admin_complaint_view_single.php?cpt_id=<?php echo $row["comp_id"]; ?> " class="btn btn-black py-10 px-6">View Complaint</a></td>
						        
						        <!-- <td class="image-prod"><div class="img" style="background-image:url(images/person_1.jpg);"></div></td>
						         -->
						        <td class="product-name">
                      <!-- heading of complaint -->
                      <i><h2 style="<?php echo $color; ?>;"><?php echo strtoupper($row["Status"]); ?></h2></i>
						        	<h3><?php echo $row["complaint_head"]; ?></h3>
						        <!--	<p>Complaint Far far away, behind the word mountains, far from the countries</p>-->
                    </td>
                    

						        <!-- complaint number -->
						        <td class="price"><?php echo $row["comp_id"]; ?></td>
<!-- 						        
						        <td class="quantity">
