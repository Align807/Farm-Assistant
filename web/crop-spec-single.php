...
<html lang="en">
  <head>
    <title>Crop specialization single | Farmer</title>
    <meta charset="utf-8">
...
<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4" style="padding-top: 20px;padding-bottom: 0px; "><u><?php echo $row["c_name"]; ?></u></h2>
            
          </div>
        </div>   		
		
    <div class="hero-wrap hero-bread" style="background-image: url('<?php echo $row["image"]; ?>');">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
                <br><br>
                <h3><?php echo $row["head1"]; ?></h3>
                <p><?php echo $row["desc1"]; ?></p>
                <br>
				<h3><?php echo $row["head2"]; ?></h3>
	          	<p><?php echo $row["desc2"]; ?></p>
                <br>
                <h3><?php echo $row["head3"]; ?></h3>               
	          	<p><?php echo $row["desc3"]; ?></p>
                <br>
                <h3><?php echo $row["head4"]; ?></h3>
